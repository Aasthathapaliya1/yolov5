...
def detect(save_img=False):
    ...
    import torch
    # model = torch.hub.load('ultralytics/yolov5', 'yolov5s', pretrained=True) # load FP32 model
    model = torch.jit.load('/home/acer/treeleaf/Aastha/vixx/resources/yolov5x.pt') # load FP32 model
    # model = torch.hub.load('ultralytics/yolov5', 'yolov5s', pretrained=True).to(device).eval() # load FP32 model
